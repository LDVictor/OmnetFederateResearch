...
#endif
{
  ...
  public:
     ...
     * Novas funcoes.
     */
/*    virtual b getVersion() const = 0;
    virtual b getType() const = 0;
    virtual b getTokenLength() const = 0;
    virtual b getCode() const = 0;
    virtual b getMessageID() const = 0;
    virtual b getPayload() const = 0;*/
    /**
     * End Novas funcoes.
     */
